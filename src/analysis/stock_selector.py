...
from src.core.exceptions import AnalysisError, DataFetchError, ModelLoadError, ValidationError
from src.core.logger import get_logger
from src.core.parallel import ParallelProcessor
from src.utils.data_utils import clean_dataframe, validate_dataframe
from src.utils.date_utils import format_date, get_yesterday
from src.utils.validation import validate_range, validate_stock_code
...
class StockSelector(AnalyzerBase):
    ...
    def predict_stocks(
        ...
        # Always use sequential for now (parallel has pickling issues)
